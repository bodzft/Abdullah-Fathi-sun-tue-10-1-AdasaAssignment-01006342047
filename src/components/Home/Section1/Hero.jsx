      ...
      <div className="container position-relative z-2">
        <div className="row justify-content-center text-center">
          <div className="col-lg-10 col-xl-8">
            <div className={`d-inline-flex align-items-center ${heroCss.badge}`}>
              <span className={heroCss.badgeDot}></span>
              <span className={heroCss.badgeDotMain}></span>
              <span>مرحباً بك في منصة عدسة</span>
            </div>

            <h1 className={heroCss.mainTitle}>
              اكتشف <span className={heroCss.highlightText}>عالم</span>
              <br />
              التصوير الاحترافي
            </h1>

            <p className={heroCss.subtitle}>
              تعلّم أساسيات التصوير واطّلع على خبرات المحترفين لتطوير مهاراتك خطوة بخطوة.
            </p>
            ...
            <div className="row mt-5 g-3 justify-content-center">
              <div className="col-6 col-md-3">
                <div className={heroCss.statCard}>
                  <i className={`fa-regular fa-newspaper ${heroCss.statIcon}`}></i>
                  <h3 className={heroCss.statNumber}>45+</h3>
              ...
              <div className="col-6 col-md-3">
                <div className={heroCss.statCard}>
                  ...
                  <h3 className={heroCss.statNumber}>+8 آلاف</h3>
              ...
              <div className="col-6 col-md-3">
                <div className={heroCss.statCard}>
                  <i className={`fa-regular fa-folder-open ${heroCss.statIcon}`}></i>
                  <h3 className={heroCss.statNumber}>5</h3>
              ...
              <div className="col-6 col-md-3">
                <div className={heroCss.statCard}>
                  ...
                  <h3 className={heroCss.statNumber}>7</h3>
                  <span className={heroCss.statLabel}>محرر</span>
                </div>
              </div>
            </div>
          </div>
